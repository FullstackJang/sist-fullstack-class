...
public class UsePerson{
	public static void main(String[] args) {
		...
		System.out.println("--------------인터페이스의 abstract method 호출-----------------");
		System.out.println(superman.getName() + "은" + superman.drivingForce()+"의 추진력을 가져야 날 수 있다.");
		System.out.println(superman.getName() + "은" + superman.upwardForce()+"의 양력을 가져야 계속 날 수 있다.");
