	...
	public static void main(String[ ] args) {
		...
		*/
		...
		if(month%12 == 0) System.out.println("원숭이");
			...
			else if(month%12 == 2)System.out.println("개");
			else if(month%12 == 3)System.out.println("돼지");
			else if(month%12 == 4)System.out.println("쥐");
			else if(month%12 == 5)System.out.println("소");
			else if(month%12 == 6)System.out.println("호랑이");
			else if(month%12 == 7)System.out.println("토끼");
			else if(month%12 == 8)System.out.println("용");
			else if(month%12 == 9)System.out.println("뱀");
			else if(month%12 == 10)System.out.println("말");
			else if(month%12 == 11)System.out.println("양");
	}
}
